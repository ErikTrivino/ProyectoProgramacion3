    ...
    void btnIngresar_loginView(ActionEvent actionEvent) throws DatosNulosException, VendedorNoExisteException, IOException, AccesoNoAutorizadoException {
        ...
        if (!(usuario.equals("") && contrasenia.equals(""))){
            ...
            if(modelFactoryController.marketPlace.obtenerAdmin(usuario, contrasenia)){
                Administrador admin = modelFactoryController.getMarketPlace().getAdmin();
                FXMLLoader loader = new FXMLLoader();
                loader.setLocation(getClass().getResource("/co/edu/uqvirtual/markerplace/marketplaceView.fxml"));
                ...
                if(modelFactoryController.verificarVendedorExistente(usuario)){
                    ...
                    if(modelFactoryController.verificarLogin(usuario, contrasenia)){
                        Vendedor vendedorLogin = modelFactoryController.obtenerVendedor(usuario);
                        modelFactoryController.setVendedorActual(vendedorLogin);
                        FXMLLoader loader = new FXMLLoader();
                        loader.setLocation(getClass().getResource("/co/edu/uqvirtual/markerplace/marketplaceView.fxml"));
